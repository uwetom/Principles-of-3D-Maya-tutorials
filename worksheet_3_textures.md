...
- Maya has lots of materials we can choose. Different materials are useful for different outputs.We will ulimately be exporting our models for use in Unity and will therefore use StingRay PBR materials.
- Select you cube, hold down the right mouse button and select 

	![](images/worksheet_1/new_material.jpg)
	
- Select Maya > Stingray PBS
...
- Change the colour of the material by double clicking on the box next to **Base Color**
...
- Create another cube, move it next to the first and assign a new Stingray material just like we did above.
...
- On the material attributes panel tick "use colour Map"

	![](images/worksheet_1/use_colour_map.jpg)

- Click the black and white button next to Colour map to 

	![](images/worksheet_1/choose_colour_map.jpg)

- Then click on the folder icon an find the giraffe pattern you downloaded from blackboard earlier

- You should now see the pattern applied to your cube

	![](images/worksheet_1/giraffe_texture_applied.jpg)

- You can change the scale and position of the texture by using the **Uv Scale** and **Uv offset** sliders. 

	![](images/worksheet_1/texture_scale.jpg)
...
- Select **Maya > StingrayPBR** as before

- turn on **Use color map** and add the colour map you just created
